    ...
    public partial class AuthorManagerViewModel : ViewModelBase
    {
        ...
        public AuthorManagerViewModel(IAuthorService authorService)
        {
            ...
            PropertyChanged += (sender, e) =>
            {
                ...
                else if (e.PropertyName == nameof(NewAuthorFirstName) || e.PropertyName == nameof(NewAuthorLastName))
                {
        ...
        {
            // Changed to only check FirstName to match the visibility condition in UpdateCanSaveAuthor()
            return SelectedAuthor != null && !string.IsNullOrWhiteSpace(SelectedAuthor.FirstName);
        }
        ...
        private void UpdateCanSaveAuthor()
        {
            ...
            // Show Save button when at least first name is filled
            bool hasFirstName = !string.IsNullOrWhiteSpace(SelectedAuthor.FirstName);
            
            // Update the property directly without checking previous value
            // This ensures the binding is always notified
            CanSaveAuthor = hasFirstName;
